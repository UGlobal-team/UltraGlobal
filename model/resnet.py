...
class ResNet(nn.Module):
    ...
    def _forward_singlescale(self, x, gemp = True, rgem = True):
        ...
        x1 = self.s1(x)
        # print("################################")
        # print(f"shape2: {x1.shape}")
        x2 = self.s2(x1)
        # print("################################")
        # print(f"shape2: {x2.shape}")
        x3 = self.s3(x2) # 1 C H W
        # print("################################")
        # print(f"shape3: {x3.shape}")
        x4 = self.s4(x3)
        # print("################################")
        # print(f"shape4: {x4.shape}")
        if rgem:
            x5 = self.rgem(x4)
        else:
            x5 = x4
        # print("################################")
        # print(f"shape5: {x5.shape}")
        x5 = x5.view(x5.shape[0], x5.shape[1], -1) 
        # print("################################")
        # print(f"shape6: {x5.shape}")
        if gemp:
            x6 = self.gemp(x5)
        else:
            x6 = self.head.pool(x5)
        # print("################################")
        # print(f"shape7: {x6.shape}")
        x6 = x6.view(x6.size(0), -1)
        # print("################################")
        # print(f"shape8: {x6.shape}")
        x6 = F.normalize(x6, p=2, dim=-1)
        x7 = self.head.fc(x6)
        # print("################################")
        # print(f"shape9: {x7.shape}")
        # print("********************************")
        return x7
